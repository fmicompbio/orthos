...
![orthos logo](orthos.png){width=50%}
...
DF <- data.frame(L2CPM= assay(dec_MKL1_human,"CONTEXT")[,1],
                 L2FC=assay(dec_MKL1_human,"INPUT_CONTRASTS")[,1])
ggplot(data=DF, aes(x=L2CPM, y=L2FC)) + 
