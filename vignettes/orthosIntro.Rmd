...
In the following examples please note that the queries are run in "DEMO" mode for the sake of efficiency. For actual analysis purposes the defaul "ANALYSIS" mode should always be used.
