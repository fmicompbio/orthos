...
This **decoded** contrast corresponds directly to the **non-specific** component
...
and residual (specific) contrasts.
...
On the other hand the decoded non-specific fraction and its corresponding query hits can also be of interest in some applications as they inform on **downstream/secondary or lateral** treatment effects. 
...
# Advanced use cases: Accessing the model internals
